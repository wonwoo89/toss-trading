      ...
      <section className="panel backtest-summary">
        ...
        <div className="backtest-strategy">
          ...
          >
            ...
            <strong>{fmtBacktestPct(result.strategy.winRate * 100)}</strong>
          </div>
          <div
            className="backtest-stat"
          ...
          >
            ...
            <strong className={backtestBiasClass(result.strategy.avgReturnPct)}>
          ...
          >
            ...
            <strong className={backtestBiasClass(result.strategy.totalReturnPct)}>
          ...
          <tbody>
            {result.buckets.map((b) => (
              <tr key={b.bucket}>
                ...
                <td>{b.count > 0 ? fmtBacktestPct(b.winRate * 100) : '—'}</td>
                <td className={backtestBiasClass(b.avgReturnPct)}>
