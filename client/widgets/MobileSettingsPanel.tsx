  ...
  return (
    <section className="mobile-settings-panel" aria-label="설정">
      <div className="mobile-settings-row">
        <Typography size={14} className="mobile-settings-row__label">테마 (라이트/다크)</Typography>
        <ThemeToggle />
      </div>
      <div className="mobile-settings-row">
      ...
      <div className="mobile-settings-row">
        <Typography size={14} className="mobile-settings-row__label">신규 레이아웃 (끄면 기존 화면)</Typography>
        <MobileLayoutToggle />
      </div>
      <div className="mobile-settings-row">
