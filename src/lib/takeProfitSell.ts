...
function scaleCostContext(
  ...
  return {
    ...costContext,
    grossProfitLoss:
      costContext.grossProfitLoss !== undefined
        ? costContext.grossProfitLoss * scale
        : undefined,
    profitLossCostDrag:
      costContext.profitLossCostDrag !== undefined
        ...
        : undefined,
    costCommission:
      costContext.costCommission !== undefined
        ? costContext.costCommission * scale
        : undefined,
    costTax:
...
export function getTakeProfitCostContext(
  holding?: HoldingItem,
): TakeProfitCostContext | undefined {
...
export async function waitForTakeProfitSnapshot<T extends {
